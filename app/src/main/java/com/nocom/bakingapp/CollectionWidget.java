...
public class CollectionWidget extends AppWidgetProvider {
    ...
    public static final String EXTRA_ITEM = " com.nocom.bakingapp.CollectionWidget.EXTRA_ITEM";
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for(int i = 0; i < appWidgetIds.length; i ++) {
            Intent intent = new Intent(context,  com.nocom.bakingapp.WidgetService.class);
          ...
          //  intent.putExtra(Intent.EXTRA_TEXT,);
           // intenti.putExtra(Intent.EXTRA_REFERRER, currentRecipie.getNsteps());
